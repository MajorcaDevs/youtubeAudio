...
export default class SearchPanel extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                {val => val && (styles => (
                    <div id="searchPanel" style={styles}>
                                    ...
                                    <div key={i} className="row mb-1 result">
                                        ...
                                        <div className="col row">
                                            ...
                                            <div className="col-12 align-self-end">
                                                <button className="btn btn-link" onClick={ e => { e.preventDefault(); onPlayClicked(item); } }>
                                                    <i className="material-icons">play_circle_outline</i>
                                                </button>
                                                <button className="btn btn-link" onClick={ e => { e.preventDefault(); onEnqueueClicked(item); } }>
